...
csv_file_path = "./data/class_mapping.csv"
...
def load_class_mapping_from_csv(csv_file_path):
    class_mapping_df = pandas.read_csv(csv_file_path)
    class_mapping = dict(zip(class_mapping_df['answer'], class_mapping_df['class_id']))
...
def main():
    ...
    np.save("submission_v3.npy", submission)
